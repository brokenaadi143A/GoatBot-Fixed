module.exports = {
 ...
 longDescription: {
 vi: "",
 en: "Approve Your Bot Pending Threads"
 },
 category: "admin"
 },
 ...
 for (const singleIndex of index) {
 if (isNaN(singleIndex) || singleIndex <= 0 || singleIndex > Reply.pending.length) return api.sendMessage(getLang("invaildNumber", singleIndex), threadID, messageID);
 api.sendMessage(`QueenBot is successfully connected 🫂🤍:\n\n•Join here to learn more about the bot:\nhttps://facebook.com/groups/7067206133407080/\n\n•Type ${prefix}enter to enter the messenger group 🙂🤍\n\n•Type ${prefix}help1 to view the bot's commands 🫂🌝🤍`, Reply.pending[singleIndex - 1].threadID);
 count+=1;
 }
